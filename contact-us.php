...
<body>
	...
	<section class="contact-us">
		<ul class="contact-table">
			<li>
				<p># 718, 2nd Floor, Hansa Plaza,</p>
				<p> 24th Main, J P Nagar 6th Phase,</p>
			...
			<li>
				<p>For Sales Support: contactus@docpulse.com
					For Technical queries and post sales: support@docpulse.com</p>
			</li>
		</ul>
